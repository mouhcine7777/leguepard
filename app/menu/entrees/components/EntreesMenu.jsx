...
const sections = [
  {
    category: "Froides",
    items: [
      { name: "Soupe Bortsch froide et crabe VG", price: "110", ingredients: "Soupe froide de betterave d’inspiration russe", description: "Une soupe froide d'inspiration russe revisitée — la douceur terreuse de la betterave rencontre la finesse iodée du crabe. Fraîche, élégante, inattendue." },
  ...
  },
  {
    ...
    items: [
      { name: "Tiradito de Thon", price: "150", ingredients: "Leche de tigre à l’avocat, calamar croustillant, radis, navet & jalapeño", description: "Entre sashimi et ceviche, le tiradito met le thon à l'honneur. L'avocat adoucit, le jalapeño pique, le calamar croustillant apporte la texture." },
      { name: "Saumon Tataki", price: "140", ingredients: "Fenouil, edamame, concombre, coriandre, oignon & ponzu", description: "Le saumon saisi à la flamme, servi en salade fraîche. La sauce ponzu lie les saveurs asiatiques et méditerranéennes dans une assiette lumineuse et équilibrée." },
    ],
  },
];
