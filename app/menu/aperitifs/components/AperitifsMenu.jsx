    ...
    items: [
      {
        ...
        price: "",
        ingredients: "Mini plateau fromage — assortiment de la maison",
        description: "Un plateau soigneusement sélectionné pour ouvrir l'appétit. Affinages du moment, servis avec leurs accompagnements.",
      },
      {
        name: "Saint-Jacques à la Parmesana",
        price: "",
        ingredients: "Noix de Saint-Jacques, Parmigiano Reggiano, beurre noisette",
        description: "Suggestion du Chef. La douceur iodée de la Saint-Jacques sublimée par le caractère du parmesan — une bouchée délicate et généreuse.",
      },
      {
        name: "Olives all'Ascolana",
        price: "",
        ingredients: "Olives farcies au fromage, panure croustillante, frites",
        description: "Une spécialité italienne revisitée. L'olive fondante rencontre un cœur de fromage, enrobée d'une fine panure dorée à la friture.",
      },
      {
        name: "Tarama & Chips de Pain Lavash",
        price: "",
        ingredients: "Tarama maison, pain lavash croustillant",
        description: "Onctueux et fumé, le tarama se marie à la légèreté craquante du pain lavash — une entrée en matière élégante.",
      },
      {
        name: "Shrimp Toast Vietnamien",
        price: "",
        ingredients: "Crevettes, pain de mie, sésame, sauce nuoc-mâm",
        description: "Croustillant à l'extérieur, moelleux à l'intérieur. Une invitation au voyage entre Saïgon et les rives de la Méditerranée.",
      },
    ],
  },
];
