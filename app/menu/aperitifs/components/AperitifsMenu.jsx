...
const sections = [
  {
    category: "Bouchées",
    items: [
      { name: "Sélection de Fromages", price: "110", ingredients: "Mini plateau fromage — assortiment de la maison", description: "Un plateau soigneusement sélectionné pour ouvrir l'appétit. Affinages du moment, servis avec leurs accompagnements." },
      ...
      { name: "Olives all'Ascolana", price: "60", ingredients: "Olives farcies au fromage, panure croustillante, frites", description: "Une spécialité italienne revisitée. L'olive fondante rencontre un cœur de fromage, enrobée d'une fine panure dorée à la friture." },
