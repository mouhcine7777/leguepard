...
export default function ChampagnesVinsHero() {
  return (
    <section
    ...
    >
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 className="text-[23px] sm:text-[48px] tracking-[0.18em] uppercase text-[#EAD4BA] font-light leading-none mb-4">
          Champagnes & Vins
        </h1>
