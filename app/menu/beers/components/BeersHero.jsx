...
export default function BieresAlcoolsHero() {
  return (
    <section
    ...
    >
      ...
      <svg className="absolute inset-0 w-full h-full opacity-10 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="spots-hero-bieres" x="0" y="0" width="160" height="120" patternUnits="userSpaceOnUse">
            {[
        ...
        <rect width="100%" height="100%" fill="url(#spots-hero-bieres)" />
      </svg>
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 className="text-[25px] sm:text-[48px] tracking-[0.18em] uppercase text-[#EAD4BA] font-light leading-none mb-4">
          Bières & Alcools
        </h1>
